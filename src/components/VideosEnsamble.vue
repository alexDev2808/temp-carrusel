...
// Props y datos
const elementos = [
  { id: 1, videoName: 'PoliticasDerechosHumanos.mp4', title: 'Políticas de Derechos Humanos' },
  { id: 2, videoName: 'potenza.mp4', title: 'Potenza' },
  { id: 3, videoName: 'viena.mp4', title: 'Viena' },
]
